...
//                }
                ...
                var getPatternMasterByInputCode = function () {
                    $http.get(Path.getUri("api/bill-pattern?inputCode=" + $scope.inputParam.value)).success(
                        function (data) {
