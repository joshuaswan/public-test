        ...
        .directive('treecontrol', ['$compile', function ($compile) {
            ...
            return {
                ...
                controller: ['$scope', function ($scope) {
                    ...
                    //自定义双击事件
                    $scope.dbClickNodeLabel = function () {
                        if ($scope.selectedNode != undefined) {
                            if ($scope.doubleClickNode)
                                $scope.doubleClickNode({node: $scope.selectedNode});
                        }
                    }
                    ...
                    var template =
                        ...
                        '<div class="tree-label ' + classIfDefined($scope.options.injectClasses.label, false) + '" ng-class="selectedClass()" ng-click="selectNodeLabel(node)" ng-dblclick="dbClickNodeLabel(node)" tree-transclude></div>' +
